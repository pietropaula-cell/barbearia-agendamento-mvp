...
## Horário de Trabalho da Barbearia (Jun 2026 - Rodada 6)
- [ ] Remover status "Fechado" do card da barbearia na Home
- [ ] Remover foto da fachada do card
- [ ] Exibir horário de trabalho no card da barbearia na Home
- [ ] Implementar validação de horários (abertura < fechamento)
- [ ] Adicionar testes para exibição de horário de trabalho
